...
total_sub_cls=[]
train_file = "ANATOMY_data/ANATOMY_train.txt"
va_file = "ANATOMY_data/ANATOMY_valid.txt"
test_file = "ANATOMY_data/ANATOMY_test.txt"
...
gdata_file="ANATOMY_data/anatomy_norm_mod.owl"
...
valid_data_file="ANATOMY_data/ANATOMY_valid.txt"
...
for d in embed_dims:
    ...
    for m in margins:
        ...
        out_classes_file = f'ANATOMY_results/EL/ANATOMY_{embedding_size}_{margin}_{epochs}_cls.pkl'
        out_relations_file = f'ANATOMY_results/EL/ANATOMY_{embedding_size}_{margin}_{epochs}_rel.pkl'
        loss_history_file= f'ANATOMY_results/EL/ANATOMY_lossHis_{embedding_size}_{margin}_{epochs}.csv'
