...
#This function loads all the subclass TBox statements in ontology
...
for d in embed_dims:
    ...
    for m in margins:
        ...
        out_classes_file = f'GO_results/EL/GO_{embedding_size}_{margin}_{epochs}_cls.pkl'
        out_relations_file = f'GO_results/EL/GO_{embedding_size}_{margin}_{epochs}_rel.pkl'
        loss_history_file= f'GO_results/EL/GO_lossHis_{embedding_size}_{margin}_{epochs}.csv'
