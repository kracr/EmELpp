...
for d in embed_dims:
    ...
    for m in margins:
        ...
        out_classes_file = f'FMA_results/EL/FMA_{embedding_size}_{margin}_{epochs}_cls.pkl'
        out_relations_file = f'FMA_results/EL/FMA_{embedding_size}_{margin}_{epochs}_rel.pkl'
        loss_history_file= f'FMA_results/EL/FMA_lossHis_{embedding_size}_{margin}_{epochs}.csv'
