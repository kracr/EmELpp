...
for d in embed_dims:
    ...
    for m in margins:
        ...
        out_classes_file = f'GALEN_results/EL/GALEN_{embedding_size}_{margin}_{epochs}_cls.pkl'
        out_relations_file = f'GALEN_results/EL/GALEN_{embedding_size}_{margin}_{epochs}_rel.pkl'
        loss_history_file= f'GALEN_results/EL/GALEN_lossHis_{embedding_size}_{margin}_{epochs}.csv'
