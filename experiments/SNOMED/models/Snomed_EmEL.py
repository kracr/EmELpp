...
#         loss_dis = self.dis_loss(dis)
    ...
    def chain_loss(self,input):
        ...
        #dot_product1 = tf.reduce_sum(tf.multiply(c,e))
        #dot_product2 = tf.reduce_sum(tf.multiply(d,e))
        #mag_r1 = tf.norm(c, axis=1)
        #mag_r2 = tf.norm(d, axis=1)
        #mag_e = tf.norm(e, axis=1)
        #prod1 = dot_product1/(mag_e*mag_r1)
        #prod2 = dot_product2/(mag_e*mag_r2)
        #dst_theta = (1 - (prod1 + prod2)) 
        res_vec = c + d
